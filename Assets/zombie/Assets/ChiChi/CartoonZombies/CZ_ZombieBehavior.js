...
var SpiderMan : GameObject;
private var distanceFromSpiderMan : float;

function Start () {

size=Random.Range(0.35, 0.45);
...
SpiderMan = GameObject.FindGameObjectWithTag("Player");
transform.LookAt(SpiderMan.transform.position);
distanceFromSpiderMan = Vector3.Distance(transform.position, SpiderMan.transform.position);
...
if(distanceFromSpiderMan < 1.5f && timer <= 0)
{
	state = "attack";
	timer = 30;
}
